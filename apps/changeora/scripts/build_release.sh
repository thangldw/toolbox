...
UNIVERSAL="${CHANGEORA_UNIVERSAL:-auto}"
...
ARCHIVE="$RELEASE_DIR/Changeora-$VERSION-macos-$ARCH_LABEL-unsigned.zip"

mkdir -p "$RELEASE_DIR"
CHANGEORA_UNIVERSAL="$UNIVERSAL" "$PROJECT_DIR/scripts/build_app.sh"
